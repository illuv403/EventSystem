...
public class StandardClassTests
{
    ...
    public void StandardCreationTest()
    {
        ...
        Assert.Equal(new DateTime(2025, 12, 12), _standard.EventForTicket.StartDateAndTime);
        Assert.Equal(new DateTime(2025, 12, 23), _standard.EventForTicket.EndDateAndTime);
