...
public class TestData
{
    ...
    // <<Objects>> //
    public static Address Address() => new("Poland", "Warsaw", _Address(), "12", "02-495", new List<Staff>());

    public static Club Club() => new(123, _Address(), new List<Event>());

    public static Customer Customer() => new("Daniel", "Eroth", "d.eroth@gmail.com", PhoneNumber(), BirthDate(), new List<Order>());
    
    public static Event Event() => new("TTL", StartDateTime(), EndDateTime(), Description(),new List<Organizer>(), new List<Staff>(), new List<Customer>(), Location(), new List<Ticket>());
    ...
    public static Location Location() => new(455, _Address(), new List<Event>());
    ...
    public static Order Order() => new(Customer(), new List<Ticket>());
    
    public static Organizer Organizer() => new("Alexandra", "Kowalska", "kow.all@gmail.com", PhoneNumber(), BirthDate(), new decimal(2290.0), new List<Staff>(),new List<Event>());
